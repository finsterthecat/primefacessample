...
@NamedQueries({
    ...
    @NamedQuery(name = "Customer.findByAddressline1",
            query = "SELECT c FROM Customer c WHERE c.addressline1 = :addressline1"),
    @NamedQuery(name = "Customer.findByAddressline2",
            query = "SELECT c FROM Customer c WHERE c.addressline2 = :addressline2"),
    ...
    @NamedQuery(name = "Customer.findByCreditLimit",
...
public class Customer implements Serializable {
  ...
  public String toString() {
    return "com.brouwer.primefacessample.Customer[ customerId=" + customerId + " ]";
  }
